package com.atguigu.atguigu_code.json.activity;
...
import com.atguigu.atguigu_code.json.bean.DataInfo;
import com.atguigu.atguigu_code.json.bean.FilmInfo;
import com.atguigu.atguigu_code.json.bean.ShopInfo;
...
public class NativeJsonPraseActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        tv_titlebar_name.setText("手动JSON解析");
