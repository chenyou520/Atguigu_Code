package com.atguigu.atguigu_code.countdownview.activity;
...
import com.atguigu.atguigu_code.countdownview.DividerItemDecoration;
...
public class CountdownViewRecyclerViewActivity extends AppCompatActivity {
    ...
    private RecyclerView cv_familiarRecyclerView;
...
//        FamiliarRecyclerView cvFamiliarRecyclerView = (FamiliarRecyclerView) findViewById(R.id.cv_familiarRecyclerView);
        cv_familiarRecyclerView = (RecyclerView) findViewById(R.id.cv_familiarRecyclerView);
        cv_familiarRecyclerView.setAdapter(mMyAdapter = new MyAdapter(this, mDataList));
        //设置布局管理器
        cv_familiarRecyclerView.setLayoutManager(new LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false));
        //添加分割线
        //网络地址http://blog.csdn.net/lmj623565791/article/details/45059587
        cv_familiarRecyclerView.addItemDecoration(new DividerItemDecoration(this,DividerItemDecoration.VERTICAL_LIST));
    }
