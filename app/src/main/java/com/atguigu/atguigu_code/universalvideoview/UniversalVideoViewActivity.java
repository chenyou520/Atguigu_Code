...
package com.atguigu.atguigu_code.universalvideoview;
...
public class UniversalVideoViewActivity extends Activity implements UniversalVideoView.VideoViewCallback {
    ...
    private static final String TAG = UniversalVideoViewActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_titlebar_name.setText("UniversalVideoView");
